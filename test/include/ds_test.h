...
class DSTest {
  ...
  private:
    ...
    char* data_;
    // 
    patch::thread_safe_vec<pthread_t*> put_thread_ptr_vector;
    patch::thread_safe_vec<pthread_t*> get_thread_ptr_vector;
    patch::thread_safe_vec<struct pthread_arg_struct> put_thread_arg_struct_vector;
    patch::thread_safe_vec<struct pthread_arg_struct> get_thread_arg_struct_vector;
};
